...
alias vol="alsamixer"
alias stats="conky -b &"
alias unmute="amixer -c 0 set Master playback 0% unmute"
...
PATH="/home/dams/perl5/bin${PATH:+:${PATH}}"; export PATH;
PERL5LIB="/home/dams/perl5/lib/perl5${PERL5LIB:+:${PERL5LIB}}"; export PERL5LIB;
